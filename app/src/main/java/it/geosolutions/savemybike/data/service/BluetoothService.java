...
public class BluetoothService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        bluetoothManager = BluetoothBleManager.get();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        isRunning = true;
        if (bluetoothManager.initialize(this))
    ...
    public void onDestroy() {
        ...
        bluetoothManager.setActive(false);
        isRunning = false;
    }
    ...
    public void issueRequest(String uuid) {
        ...
        ResponseSensorsCallback callback = new ResponseSensorsCallback(command, this);
        client.performAuthenticatedCall(
                portalServices.getTaggedBike(uuid), callback);
    }
